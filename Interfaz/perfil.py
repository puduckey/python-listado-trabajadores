...
class PerfilUsuario(tk.Tk):
    def __init__(self, usuario, trabajador, cargas_familiares, contactos_emergencia):
        ...
        if usuario.username != "admin":
            ...
            linea_dialogo = tk.Label(self, text="Este perfil es una cuenta de administrador por defecto y no está asociada a ningún trabajador.")
            linea_dialogo.pack()
    ...
    def actualizar_informacion(self):
        ...
        registro_trabajador.mostrar_datos_trabajador(self.trabajador, self.cargas_familiares, self.contactos_emergencia, False)
        self.destroy()
